...
{
    public class CrewTitleConfiguration : IEntityTypeConfiguration<CrewTitle>
    {
        public void Configure(EntityTypeBuilder<CrewTitle> builder)
        {
            builder.HasKey(x => x.Id);
            builder.Property(x => x.Id).HasConversion(id => id.Value, dbId => CrewTitleId.Of(dbId));
